...
The prototype itself is available [here](https://github.com/logpicker/prototype). It uses a slightly modified version of [bls-signatures](https://github.com/Chia-Network/bls-signatures) available [here](https://github.com/Chia-Network/bls-signatures) which is automatically pulled in during the build.
